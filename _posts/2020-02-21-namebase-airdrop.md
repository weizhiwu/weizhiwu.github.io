...
3. 第二步，安装 hs-airdrop 工具：
    ...
    我在 npm install 时遇到过两个问题，一个是 `Your PYTHONPATH points to a site-packages dir ...`，解决方案参考 <https://weizhiwu.github.io/wiki/python/#your-pythonpath-points-to-a-site-packages-dir>，另一个是 `No Xcode or CLT version detected`，解决方案参考 <https://weizhiwu.github.io/wiki/mac/#no-xcode-or-clt-version-detected>。
